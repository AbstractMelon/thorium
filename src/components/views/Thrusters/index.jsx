              ...
              <Fragment>
                  ...
                  >
                    ...
                    onStop={this.onDragHandler("onDragStop", "direction")}>
                      ...
                      style={{
                        ...
                        this.state.direction.left * width / 2}px,${

                        this.state.direction.top * height / 2}px,0px)`
                  ...
                  <div className="draggerBar">
                    ...
                    onStop={this.onDragHandler("onDragStop", "directionUp")}>
                      ...
                      style={{
                        transform: `translate3d(${
                        this.state.directionUp.left * (width - 40) / 2}px,0px,0px)`
            ...
            <Col className="col-sm-6" style={{ minHeight: "50vh" }}>
              ...
              <Row>
                  <Col className="col-sm-6 col-sm-offset-3">
                    ...
                    label={`${
                    this.state.control ? "Deactivate" : "Activate"} Manual Control`
                    } />
              ...
              <Fragment>
                  ...
                  <div className="draggerCircle">
                    ...
                    onStop={this.onDragHandler("onDragStop", "rotation")}>
                      ...
                      style={{
                        transform: `translate3d(${
                        this.state.rotation.left * width / 2}px,${
                        this.state.rotation.top * height / 2}px,0px)`
                      }} />
                  ...
                  <div className="draggerBar">
                    ...
                    onStop={this.onDragHandler("onDragStop", "yaw")}>
                      ...
                      style={{
                        transform: `translate3d(${
                        this.state.yaw.left * (width - 40) / 2}px,0px,0px)`
