    ...
    return (
      <div className={`grid`} style={{ width: radius, height: radius }}>
        ...
        <div
          ...
          style={{
            transform: `translate(${
            Math.cos(d2r(i / array.length * 360)) * radius / 2}px, ${

            Math.sin(d2r(i / array.length * 360)) * radius / 2}px)`
            ...
            if (i) {
              return (
                <div
                  ...
                  style={{
                    transform: `translate(${
                    Math.cos(d2r((i - 3) / lines * 360)) * radius / 2}px, ${

                    Math.sin(d2r((i - 3) / lines * 360)) * radius / 2}px)`
