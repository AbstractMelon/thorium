        ...
        {draggingCable &&
          ...
          draggingCable.location.y !== 0 && (
            <div
              ...
              style={{
                transform: `translate(${draggingCable.location.x}px, ${draggingCable.location.y}px)`,
              }}
            />
          )}

        <svg className="connectors">
          {draggingCable && draggingCable.component && (
            <DraggingLine
              width={width}
              height={height}
          ...
          (() => {
            ...
            return (
              <div
                ...
                style={{
                  transform: `translate(${componentLocation.x}px, ${componentLocation.y}px)`,
                }}
              >
                <Comp />
              </div>
